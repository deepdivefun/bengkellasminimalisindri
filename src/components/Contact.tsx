...
const Contact = () => {
    ...
    return (
        <section className='bg-zinc-950 text-white p-12'>
        <div className='mx-6  my-12'>
            <div className='flex gap-6'>
                <span className='text-xl border rounded-full p-2 mb-6'>Tentang Kami</span>
                <h1 className='text-4xl font-bold'>Indri Teknik Las</h1>
            </div>
            <h2 className='font-semibold mb-6'>Bengkel Las Melayani Pembuatan Kanopi, Pagar, Tangga, Jendela dan Minimalis</h2>
